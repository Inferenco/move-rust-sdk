...
//!
//! ```rust,ignore
//! use move_core_sdk_macros::aptos_contract;
//!
//! aptos_contract! {
//!     name: CoinModule,
...
///
/// ```rust,ignore
/// use move_core_sdk_macros::aptos_contract_file;
///
...
///
/// ```rust,ignore
/// use move_core_sdk_macros::MoveStruct;
///
/// #[derive(MoveStruct)]
...
pub fn derive_move_struct(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        impl #name {
            ...
            pub fn to_bcs(&self) -> ::move_core_sdk::error::AptosResult<Vec<u8>> {
                ::move_core_sdk::aptos_bcs::to_bytes(self)
                    .map_err(|e| ::move_core_sdk::error::AptosError::Bcs(e.to_string()))
            }

            /// Deserializes this struct from BCS bytes.
            pub fn from_bcs(bytes: &[u8]) -> ::move_core_sdk::error::AptosResult<Self> {
                ::move_core_sdk::aptos_bcs::from_bytes(bytes)
                    .map_err(|e| ::move_core_sdk::error::AptosError::Bcs(e.to_string()))
            }
        }
    };

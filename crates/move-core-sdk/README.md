...
Core Move SDK primitives — cryptography, transaction building, and network client shared by all Move-based chains. This is the underlying implementation used by [`move-rust-sdk`](https://crates.io/crates/move-rust-sdk).

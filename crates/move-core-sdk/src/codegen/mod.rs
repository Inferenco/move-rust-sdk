...
//!
//! ```rust,ignore
//! use move_core_sdk::codegen::{ModuleGenerator, GeneratorConfig};
//! use move_core_sdk::api::response::MoveModuleABI;
//!
...
//! ```rust,ignore
//! // build.rs
//! use move_core_sdk::codegen::build_helper;
//!
//! fn main() {
...
//!
//! ```rust,ignore
//! use move_core_sdk::codegen::{ModuleGenerator, GeneratorConfig, MoveSourceParser};
//!
//! // Load ABI
//! let abi: MoveModuleABI = serde_json::from_str(&abi_json)?;
//!

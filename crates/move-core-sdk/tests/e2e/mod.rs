...
//! cargo test -p move-core-sdk --features "e2e,full"
//! ```
//!
...
use move_core_sdk::{Aptos, AptosConfig};
use std::env;
...
mod transaction_tests {
    ...
    async fn e2e_simulate_transaction() {
        use move_core_sdk::account::Account;
        use move_core_sdk::transaction::authenticator::{Ed25519PublicKey, Ed25519Signature};
        use move_core_sdk::transaction::{SignedTransaction, TransactionAuthenticator};
    ...
    async fn e2e_get_transaction_by_hash() {
        use move_core_sdk::types::HashValue;
    ...
    async fn e2e_transaction_expiration() {
        ...
        let raw_txn = move_core_sdk::transaction::TransactionBuilder::new()
...
mod multi_signer_tests {
    use super::*;
    use move_core_sdk::account::{Account, Ed25519Account};
    use move_core_sdk::transaction::{
        EntryFunction, Script, ScriptArgument, TransactionBuilder, TransactionPayload,
...
mod multi_key_e2e_tests {
    use super::*;
    use move_core_sdk::account::{AnyPrivateKey, MultiKeyAccount};
    use move_core_sdk::crypto::{Ed25519PrivateKey, Secp256k1PrivateKey};
    use move_core_sdk::transaction::{
    ...
    async fn e2e_multi_key_account_transfer() {
        ...
        let recipient = move_core_sdk::account::Ed25519Account::generate();
...
mod single_key_tests {
    use super::*;
    use move_core_sdk::account::{Ed25519Account, Ed25519SingleKeyAccount};
    use move_core_sdk::transaction::{
        EntryFunction, TransactionBuilder, builder::sign_transaction,
    };
...
mod secp256k1_tests {
    use super::*;
    use move_core_sdk::account::{Ed25519Account, Secp256k1Account};
    use move_core_sdk::transaction::{
        EntryFunction, TransactionBuilder, builder::sign_transaction,
    };
...
mod webauthn_tests {
    use super::*;
    use move_core_sdk::account::WebAuthnAccount;
    use move_core_sdk::transaction::{
        EntryFunction, TransactionBuilder, builder::sign_transaction,
    };
...
mod multi_ed25519_tests {
    use super::*;
    use move_core_sdk::account::{Ed25519Account, MultiEd25519Account};
    use move_core_sdk::crypto::Ed25519PrivateKey;
    use move_core_sdk::transaction::{
        EntryFunction, TransactionBuilder, builder::sign_transaction,
    };
...
mod batch_tests {
    use super::*;
    use move_core_sdk::account::Ed25519Account;
    use move_core_sdk::transaction::{InputEntryFunctionData, TransactionBatchBuilder};
...
mod gas_tests {
    use super::*;
    use move_core_sdk::account::Ed25519Account;
    use move_core_sdk::transaction::EntryFunction;
...
mod sponsored_builder_tests {
    use super::*;
    use move_core_sdk::account::Ed25519Account;
    use move_core_sdk::transaction::{EntryFunction, SponsoredTransactionBuilder};

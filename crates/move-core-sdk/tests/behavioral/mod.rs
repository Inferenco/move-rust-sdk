...
mod multi_scheme_crypto_tests {
    ...
    fn test_cross_scheme_verification_fails() {
        ...
        let secp_sig_result = move_core_sdk::crypto::Secp256k1Signature::from_bytes(&ed_sig_bytes);
        assert!(
...
mod account_tests {
    ...
    use move_core_sdk::account::Mnemonic;
...
mod multi_ed25519_tests {
    use move_core_sdk::account::MultiEd25519Account;
    use move_core_sdk::crypto::Ed25519PrivateKey;
    ...
    fn test_multi_ed25519_insufficient_keys() {
        ...
        let public_keys: Vec<_> = all_keys
            .iter()
            .map(move_core_sdk::crypto::Ed25519PrivateKey::public_key)
            .collect();
...
#[cfg(all(feature = "ed25519", feature = "secp256k1"))]
mod multi_key_tests {
    use move_core_sdk::account::{Account, AnyPrivateKey, MultiKeyAccount};
    use move_core_sdk::crypto::{AnyPublicKey, Ed25519PrivateKey, Secp256k1PrivateKey};
...
mod transaction_tests {
    use move_core_sdk::transaction::{EntryFunction, TransactionBuilder, TransactionPayload};
...
mod signing_flow_tests {
    ...
    fn test_sign_transaction_flow() {
        ...
        match &signed_txn.authenticator {
            move_core_sdk::transaction::TransactionAuthenticator::Ed25519 {
                public_key,
                signature,
            } => {
...
mod types_tests {
    use move_core_sdk::types::{AccountAddress, ChainId, HashValue, TypeTag};
...
mod error_tests {
    use move_core_sdk::error::AptosError;
...
mod auth_key_tests {
    use move_core_sdk::account::{Account, Ed25519Account, Ed25519SingleKeyAccount};
    use move_core_sdk::crypto::{
    ...
    fn test_scheme_byte_values() {
        use move_core_sdk::crypto::{KEYLESS_SCHEME, MULTI_ED25519_SCHEME, MULTI_KEY_SCHEME};

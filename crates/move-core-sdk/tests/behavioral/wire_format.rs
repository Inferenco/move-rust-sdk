...
use move_core_sdk::crypto::{AnyPublicKey, Ed25519PrivateKey, sha3_256};
use move_core_sdk::transaction::TransactionPayload;
use move_core_sdk::transaction::authenticator::{
    AccountAuthenticator, Ed25519PublicKey as AuthEd25519PublicKey,
    Ed25519Signature as AuthEd25519Signature,
};
use move_core_sdk::transaction::payload::EntryFunction;
use move_core_sdk::transaction::types::{RawTransaction, RawTransactionOrderless};
use move_core_sdk::types::{AccountAddress, ChainId, TypeTag};
...
fn account_authenticator_multi_key_bcs_layout_is_pinned() {
    ...
    use move_core_sdk::crypto::{Ed25519PrivateKey as EdK, Secp256k1PrivateKey};
    let keys = vec![

...
use move_core_sdk::{Aptos, AptosConfig, account::Ed25519Account};
...
async fn main() -> anyhow::Result<()> {
    ...
    println!(
        r#"
    use std::fs;
    use move_core_sdk::transaction::{{EntryFunction, TransactionBuilder}};
    use move_core_sdk::types::MoveModuleId;
